        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div>
            ...
            <p className="text-navy-700 leading-relaxed mb-5">
              LS Sober Living Homes provides structured, substance-free housing
              in the Dallas/Fort Worth area for adults committed to sobriety.
            </p>
            <p className="text-navy-700 leading-relaxed mb-5">
              Every resident is held to the same clear standards — because
              structure creates safety, and safety makes growth possible.
            </p>
            <p className="text-navy-700 leading-relaxed">
              We welcome individuals from all backgrounds who share one
              commitment: living substance-free and building a more stable
              future.
            </p>
            ...
            <div className="mt-8 p-4 bg-sand-100 border-l-4 border-sage-400 rounded-r-xl">
              <p className="text-sm text-navy-600 font-medium leading-snug">
                <strong>Please note:</strong> We are not a detox, rehab, or
                clinical treatment provider. We offer structured, monitored
                sober housing only.
              </p>
            </div>
          </div>
