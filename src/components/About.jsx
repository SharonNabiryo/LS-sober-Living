        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-navy-700 leading-relaxed mb-5">
              ...
              Worth area where residents can establish stability, develop personal
              accountability, and connect with a community of peers walking a
              similar path.
            </p>
            <p className="text-navy-700 leading-relaxed mb-5">
              Our home operates with clear expectations and consistent structure.
              Every resident is held to the same standards — because structure
              creates safety, and safety makes growth possible.
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              { value: '24/7', label: 'Accountability Structure',  icon: '🏠' },
              { value: '100%', label: 'Substance-Free Environment', icon: '✅' },
              { value: 'Zero', label: 'Tolerance for Use On-Site', icon: '🛡️' },
            ].map(stat => (
              <div key={stat.label} className="card flex flex-col gap-2 text-center">
