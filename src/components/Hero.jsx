...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="section-container relative z-10 py-20 lg:py-32 text-center lg:text-left max-w-3xl">
        ...
        <div className="animate-on-load animate-delay-4 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
          <a href="#apply" className="btn-primary bg-sage-500 hover:bg-sage-600 text-white">
            Apply for Housing
          </a>
          <a href="#referrals" className="btn-secondary border-white text-white hover:bg-white hover:text-navy-900">
            Refer Someone
          </a>
        </div>
        ...
        <div className="animate-on-load animate-delay-4 mt-14 flex flex-wrap gap-6 justify-center lg:justify-start text-sand-200 text-sm font-medium">
          {['Substance-Free Environment', 'Structured & Accountable', 'DFW Area'].map(item => (
